...
object x {
  ...
  val in = Source.fromFile("/Users/gabbi/data/anDerUni/studies/distributedSystems/scala/ws/CourseraFPWithScala/src/week6_2/linuxwords.txt")
  ...
  val charCode: Map[Char, Char] = for ((digit, str) <- nmem; keyChar <- str) yield keyChar -> digit
  ...
  def encode(number: String): Set[List[String]] =
    ...
    val number = "7225247386"                     //> number  : String = 7225247386
    encode(number)                                //> res0: Set[List[String]] = Set(List(rack, ah, re, to), List(sack, ah, re, to
  ...
  translate(number)                               //> res1: Set[String] = Set(sack air fun, pack ah re to, pack bird to, Scala ir
